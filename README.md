...
This repository is the Phase 03 core runtime for the JARVIS Personal AI OS.
...
offline state, and loopback HTTP/CLI entry points. No model is loaded and no
hardware or server is opened at import or composition time.
...
operational boundaries and current Phase 03 limits.
