...
<main><section class="panel"><h2>SYSTEM STATE</h2><div id="state" class="state">OFFLINE</div><div id="system"></div></section><section class="panel"><h2>RUNS / WORKERS</h2><div id="runs"></div></section><section class="panel"><h2>DEVICES</h2><div id="devices"></div></section><section class="panel"><h2>GOALS / APPROVALS</h2><div id="goals"></div></section><section class="panel"><h2>RESEARCH / ENGINEERING</h2><div id="specialists"></div></section><section class="panel"><h2>VOICE / CONVERSATION</h2><div id="voice"></div></section><section class="panel wide"><h2>EVENT TIMELINE</h2><pre id="timeline">Waiting for authenticated state...</pre></section></main>
<script>
