...
| Mission Approval Pause & Exact Resume | `src/jarvis/missions/service.py` | `tests/test_phase_sixteen_goals_missions.py::test_mission_approval_pause_and_exact_resume` |
...
| Proactive Detectors & Cooldown Deduplication| `src/jarvis/proactive/service.py` | `tests/test_phase_sixteen_proactivity_automation.py::test_proactive_detection_and_cooldown_deduplication` |
...
| Untrusted Web-to-Memory Injection Defense | `src/jarvis/memory/policy.py` | `tests/test_phase_sixteen_security_injection.py::test_untrusted_source_prompt_injection_firewall` |
