...
by vision assistance. Microsoft UFO is not merged or imported in Phase 02.

The protocol and mock handler are tested in-process. Physical Windows UI
automation, transport security, and a real satellite process remain partial
acceptance items.
