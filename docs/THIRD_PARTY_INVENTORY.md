...
This is the Phase 01 inventory for source references and declared dependency
surfaces. It is not a final distribution notice.

| Source/component | Local evidence | License/status | Phase 01 treatment |
|---|---|---|---|
...
- Phase 01 foundation declares no runtime dependencies. Pytest is an optional
